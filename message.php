<?php
	...
	// Título del mensaje
	$titulo = "Nuevo mensaje de Incidencias";
	...
	$data .= "<div class='mensaje'>
			<h1>Nuevo mensaje de Incidencias</h1>
			<p><strong>Fecha:</strong> $fecha</p>
			<p><strong>Tipo de Incidencia:</strong> $asunto</p>
			<p><strong>Nombre:</strong> $nombre</p>
			<p><strong>Apellidos:</strong> $apellidos</p>
			<p><strong>Tel&eacute;fono:</strong> $telefono</p>
			<p><strong>Dirección de Incidencia:</strong> $direccion</p>
	        <p><strong>Descripci&oacute;n:</strong><br>$mensaje</p>
			<p><strong>Email:</strong> <a href='mailto:$email'>$email</a></p>
		</div>";

	// Las cabeceras empiezan igual
	$cabeceras = "MIME-Version: 1.0\r\n";
	$cabeceras .= "From: Incidencias Jerez<$email>\r\n";
